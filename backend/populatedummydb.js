module.exports = db => {
    ...
    //Modules
    db.modules.insertMany([{ moduleName: "CAPS", moduleCode: "CHA-3382" }, { moduleName: "SAD", moduleCode: "CHA-3382" }, { moduleName: "AdvancedProgamming", moduleCode: "CHA-3382" }, { moduleName: "ADS", moduleCode: "CHA-3382" }, { moduleName: "AI&ML", moduleCode: "CHA-3382" }, { moduleName: "MATH", moduleCode: "CHA-3382" }])

    //Course Entry
    // db.courses.insertMany({ courseName: "BScComputerScience", courseCode: "CS202348", courseLeader: (db.lecturers.find({ username: "lh383847372" })) });
